...
public class AuthUserClient {
    ...
    public Page<UserDto> getAllUsersByCourse(UUID courseId, Pageable pageable){
        ...
        String url = REQUEST_URI_AUTHUSER + this.utilsService.createUrlGetAllUsersByCourse(courseId, pageable);
    ...
    public ResponseEntity<UserDto> getOneUserById(UUID userId){
        String url = REQUEST_URI_AUTHUSER + "/users/" + userId.toString();
        return restTemplate.exchange(url, HttpMethod.GET, null, UserDto.class);
    }

    public void postSubscriptionUserInCourse(UUID courseId, UUID userId) {
        String url = REQUEST_URI_AUTHUSER + "/users/" + userId.toString() + "/courses/subscription";
