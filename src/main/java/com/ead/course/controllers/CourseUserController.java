...
public class CourseUserController {
    ...
    public ResponseEntity<Object> getAllUserByCourse(SpecificationTemplate.UserSpec spec,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(userService.findAll(SpecificationTemplate.useCourseId(courseId).and(spec), pageable));
    }
    ...
    public ResponseEntity<Object> saveSubscriptionUserInCourse(@PathVariable(value = "courseId") UUID courseId,
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body("Subscription creates sucessfully");
    }
